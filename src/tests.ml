...
let%test _ = t "(x:; x%2) fixes 6"      "[6 3 1 0]"
let%test _ = t "(x:; x%2) fix 6"        "0"
...
let%test _ = t "3 cmp 5"                "-1"
let%test _ = t "5 cmp 3"                "1"
let%test _ = t "3 cmp 3"                "0"
let%test _ = t "3.2 cmp 3"              "1"
let%test _ = t "\"a\" cmp 3"            "1"
